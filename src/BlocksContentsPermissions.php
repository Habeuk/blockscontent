...
use Drupal\blockscontent\Entity\BlocksContentsType;


/**
 * Provides dynamic permissions for Blocks contents of different types.
 *
 * @ingroup blockscontent
 *
 */
class BlocksContentsPermissions{
   ...
   *
   * @return array
   *   The BlocksContents by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (BlocksContentsType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\blockscontent\Entity\BlocksContentsType $type
   *   The BlocksContents type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(BlocksContentsType $type) {
    $type_id = $type->id();
