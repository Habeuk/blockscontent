...
class BlocksContents extends EditorialContentEntityBase implements BlocksContentsInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['paragraph_revisions'] = BaseFieldDefinition::create('entity_reference_revisions')->setLabel(t(' Sections entities revision '))->setCardinality(
      ...
      'type' => 'paragraphs',
      'weight' => 0
    ])->setDisplayConfigurable('form', TRUE)->setDisplayConfigurable('view', TRUE)->setDisplayOptions('view', [
      'label' => 'hidden',
      'type' => 'entity_reference_revisions_entity_view'
    ])->setSetting('target_type', 'paragraph')->setSetting('handler', 'default')->setTranslatable(false)->setSetting('allow_duplicate', true);
